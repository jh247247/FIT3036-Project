...
radiation that they absorb. It is this difference that causes the
system to maintain homeostasis, too warm and more white daisies grow,
causing the system to cool and vice-versa. The proposed change would
be a new type of daisy that is identical to the ``black'' variation,
besides growing in a warmer than normal climate.

TODO: describe what happens?

TODO: structure of the document

\section{Method}
The model implemented for this paper is a modified version of
daisyworld, set on a 2d grid. Each edge connects to the edge opposite,
making  a torus if it were to be modeled in 3d space. This grid is
occupied by the already introduced daisies, which absorb and reflect
different amounts of incident light energy, hence modifying their
local temperature.

TODO: Read ODD paper stuff

% # find parts that "look different" and make sure that the 95pc
% # confident that they are different. If we don't find

% # presentation stuff
% # first slide: Title - make it memorable woo
% # - name obv
% # - contact info
% # - visual stuff? make it interesting... urgh
% # - question? big picture kinda stuff

% # second slide:
% # - background info (real world example?)
% # - How does it relate?
% # - another illustration
% # third slide:
% # - What you actually changed
% # - screengrab/movie (movie preferable...)
% # - description
% # 4th slide:
% # - results
% # - plots/difference?

% # remember to do testing docs D:
% # test results in report, appendix?
% # look up ODD model explanation stuff (overview down to details)
% # run normal first...

TODO: Describe agents
  - What they contain
  - What they know about their environment
  - Spawning?
  - Maths from daisyworld paper
  - Update flow
...
TODO: Describe system
  ...
  - Update flow
  - Omit the nitty-gritty details, keep things abstract
...
\section{Future work}
TODO: Actually write about future work
 - Show the amount

\section{Conclusion}
TODO: How to conclude?
