...
\begin{figure}[ht]
  \centering
  \subfloat{\includegraphics[width=0.4\textwidth]{../sim/output/normal}\label{fig:f1}}
  \hfill
  \subfloat{\includegraphics[width=0.4\textwidth]{../sim/output/normal-avg}\label{fig:f2}}
